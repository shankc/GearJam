 ...
 */
public class GuitarGenreFragment extends Fragment {
    protected int mPhotoSize, mPhotoSpacing;
    protected ImageAdapter imageAdapter;
    protected GridView photoGrid;
    private static int[] ICONS = {R.mipmap.slash_rock, R.mipmap.acoustic, R.mipmap.geroge_benson_jazz, R.mipmap.madonna_pop, R.mipmap.dimebag_metal, R.mipmap.clapton_instrumental, R.mipmap.bb_king, R.mipmap.folk_guitar};
        ...
        photoGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putString("Instrument", "Guitar");
                    bundle.putString("Genre", "Acoustic");
                    fragobj.setArguments(bundle);
                    FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
                    ft.replace(R.id.FragmentContainer, fragobj);
                    ft.addToBackStack(null);
